            ...
            <Card className="border-2">
              ...
              <CardContent className="space-y-6">
                ...
                {registration.status === 'pending' && <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
                    <p className="text-blue-800">താങ്കളുടെ രജിസ്‌ട്രേഷൻ പൂർത്തിയായിട്ടില്ല, പണമടച്ചുള്ള രജിസ്‌ട്രേഷൻ ആണെങ്കിൽ പണം അടച്ചെന്നു ഉറപ്പു വരുത്തുക. സൗജന്യ രജിസ്‌ട്രേഷൻ ആണെങ്കിൽ ഏഴ് ദിവസ്സത്തിനുള്ളിൽ പൂർത്തിയാകും..</p>
                  </div>}
